...
script starts Flask web app
    ...
    routes: /:                    display "Hello HBNB!"
            ...
            /hbnb_filters:        display HTML with working state, city filter
            /hbnb:                display HTML with working property, amenity filter
"""
...
def html_all_filters():
    """display html page with working property, amenity filters
       runs with web static css files
    """
    state_objs = [s for s in storage.all("State").values()]
    amenity_objs = [a for a in storage.all("Amenity").values()]
